...
import mgkim.core.com.mybatis.ComSqlSessionFactory;
...
@ComponentScan(basePackages = {KProfile.GROUP},
	...
	includeFilters = {
		...
		@ComponentScan.Filter(type = FilterType.ANNOTATION, value = mgkim.core.com.annotation.KBean.class),
		@ComponentScan.Filter(type = FilterType.ANNOTATION, value = mgkim.core.com.annotation.KTaskSchedule.class)
	},
	excludeFilters = {
...
public class KInit implements ServletContextInitializer, BeanFactoryPostProcessor {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		servletContext.addListener(new mgkim.core.com.listener.KContextListener());
		servletContext.addListener(new mgkim.core.com.listener.KSessionListener());
		servletContext.addListener(new mgkim.core.com.listener.KRequestListener());
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory bf) throws BeansException {
		...
		Arrays.stream(beanFactory.getBeanNamesForType(mgkim.core.com.stereo.KFilter.class)).forEach(name -> {
