package mgkim.online.com.exception;
...
import mgkim.online.com.scheduler.ComSqlmapReloadScheduler;
import mgkim.online.com.type.TEncodingType;
import mgkim.online.com.util.KExceptionUtil;
	...
	public static KException resolve(Exception ex) {
		...
		*/
		...
		KException exception = null;
		{
			...
			if("mgkim.online.com.exception.KException".equals(clazzName)) {
				exception = (KException) ex;
			} else if("mgkim.online.com.exception.KSqlException".equals(clazzName)) {
				exception = (KException) ex;
			} else if("mgkim.online.com.exception.KSysException".equals(clazzName)) {
				exception = (KException) ex;
